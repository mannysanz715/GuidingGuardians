  ...
  return ( 
    <form className="w-100 flex flex-col justify-center items-center " onSubmit={(e) => submitFunc(e)}>
      <div className="flex gap-5 mb-4 rounded-3xl border-black justify-start items-center border px-5 ">
        <button onClick={buttonPress} value='Another Example' className="border-r border-black text-center h-10 pr-4 flex justify-center items-center">Another Example</button>
        <button onClick={buttonPress} value='Simplify' className="border-r border-black pr-4 h-10" >Simplify</button>
        <button onClick={buttonPress} value='Resources'>Resources</button>
      </div>
